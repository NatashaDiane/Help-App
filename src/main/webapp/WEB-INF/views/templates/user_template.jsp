...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="${pageContext.request.contextPath}/dashboard" class="logo">
      ...
      <span class="logo-mini"><b>Hjälp</b>i</span>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs">Welcome ${pageContext.request.userPrincipal.name}</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="${pageContext.request.contextPath}/account/profile" class="btn btn-default btn-flat">Profile</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="${pageContext.request.contextPath}/category/add"><i class="fa fa-circle-o"></i>Add a category</a></li>
            <li><a href="${pageContext.request.contextPath}/category/index"><i class="fa fa-circle-o"></i>Show all categories</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="${pageContext.request.contextPath}/account/add"><i class="fa fa-circle-o"></i>Add a student</a></li>
            <li><a href="${pageContext.request.contextPath}/account/index"><i class="fa fa-circle-o"></i>Show all students</a></li>
          </ul>
        </li>
        <li><a href="https://adminlte.io/docs"><i class="fa fa-book"></i> <span>Template Documentation</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
