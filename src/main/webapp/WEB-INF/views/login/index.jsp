...
<title>Hjälpinatorn | Log in</title>
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="#"><b>Hjälp</b>inatorn</a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			<p class="login-box-msg">Sign in to continue</p>

			<!-- This shows error message if the authentication of the user failed -->
			<b>${msg}</b>

			<form action="${pageContext.request.contextPath}/login/process-login"
				method="post">
